...
const Footer = () => {
  return (
    <section>
      ...
      >
        <h2 className="text-5xl md:text-3xl font-normal text-[#FFFFFF] mb-4 ">
          Join Us in Hospitality Success
        </h2>
        <p className="text-[#DCDCDC] font-normal text-xl mb-6 max-w-4xl mx-auto leading-relaxed">
        ...
        <button className="border border-[#FFFFFF] px-6 py-2 rounded text-[#FFFFFF] text-base font-medium">
          Join Us
        </button>
      </motion.div>
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-start max-w-6xl mx-auto px-6 md:px-8 gap-x-7">
          ...
          <div className="max-w-sm mb-8 md:mb-0">
            <Image
              ...
              height={40}
            />
            <p className="mt-4 text-[#F6F4E9] font-light text-base leading-relaxed">
          ...
          <div className="mb-8 md:mb-0">
            <h4 className="text-[#F6F4E9] text-base mb-4 font-medium">
              Quick Links
            </h4>
            <ul className="space-y-2 text-center">
              <li>
                <Link href="/" className="text-[#F6F4E9] text-base font-light">
                  Home
                </Link>
              </li>
              <li>
                <Link
                  href="/about"
                  className="text-[#F6F4E9] text-base font-light"
                >
                  About Us
                </Link>
              </li>
          ...
          {/* Social Media */}
          <div>
            <h4 className="text-[#F6F4E9] text-xl font-normal mb-4">
              Social Media
            </h4>
            <ul className="space-y-2 text-center">
              <li>
                <Link
                  ...
                  className="text-[#F6F4E9] font-light text-base"
                >
                  X
                </Link>
              </li>
        ...
        <div className="border-t border-[#222b3a] mt-10 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center max-w-6xl mx-auto px-6 md:px-8 text-[#F6F4E9] text-base font-light">
