    ...
    <section className="relative h-[80vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white px-6">
        <motion.h1
          ...
          className="text-6xl font-gilda font-normal uppercase md:text-6xl mb-4"
        >
          Hotels
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-5xl text-[#F1F1F1] leading-relaxed lg:text-xl font-normal font-general md:text-base text-center sm:text-base"
        >
